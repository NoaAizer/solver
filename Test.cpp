...
TEST_CASE("Real Variables - Linear"){
    ...
    CHECK_THROWS_AS(solve(1*x == (2*x)/(2-1-1)),std::exception);
...
TEST_CASE("Real Variables - polynom"){
    ...
    CHECK(((solve((x^2)+6*x+8 == x +2 ) == -3) || (solve((x^2)+6*x+8 == x +2 ) == -2)));
    CHECK(((solve((x^2)+5*x+6 == x +6 ) == 0) ||(solve((x^2)+5*x+6 == x +6 ) == 4)));
    CHECK(((solve((x^2) == 8-(x^2) ) == 2) || (solve((x^2) == 8-(x^2 )) == -2)));
    CHECK(((solve(2*(x^2)+5*x-3 == (x^2)+6*x+3 ) == 3) || (solve(2*(x^2)+5*x-3 == (x^2)+6*x+3 ) == -2)));
...
TEST_CASE("Complex Variables - Polynom"){
    ...
    CHECK(((solve((y^2)*2 == -8) == complex(0.0,2.0) )|| (solve((y^2)*2 == -8) == complex(0.0,-2.0)) ));
